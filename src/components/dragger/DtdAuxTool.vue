...
import { initStyle } from '../../constant/dragger';
import { DragNodeType, DtdNode, KEYBOARD_EVENTS, Mouse, MouseEventType } from '../../model';
import { DTD_MOUSE, NodeLayout, cursorAtContainerEdge, getCursorPositionInDtdNode, getLayoutNodeInContainer } from '../../constant';
...
defineExpose({
  updateStyle: resizeHandler
})
</script>

<template>
  <div :style="auxToolStyle" class="dtd-aux-tool" ref="auxToolRef">
    <div class="dtd-aux-insertion" :style="{
      ...insertionStyle,
