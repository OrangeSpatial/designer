<template>
    <div class="os-empty">
        <div class="os-empty__icon">
            <svg viewBox="0 0 1024 1024" style="width:240px;height:240px">
                <rect id="helper-drag-leftrec" width="260" height="600" fill="#eeeeee" stroke="none" fill-rule="evenodd"
                    rx="12" transform="translate(97.4763,336) translate(-27.4763,-124)"></rect>
                <rect id="helper-drag-rightrec" width="580" height="600" fill="#eeeeee" stroke="none"
                    fill-rule="evenodd" rx="12" transform="translate(443.476,336) translate(-69.5,-124)"></rect>
                <rect id="helper-drag-rec" width="210" height="100" fill="#ffffff" rx="10" stroke="none"
                ...
                <g id="helper-drag-mouse" fill="#000000" fill-rule="nonzero" opacity="1"
                ...
                <g id="helper-drag-boomrightup" opacity="0"
        ...
        <div class="os-empty__title">Drag and drop a component here</div>
    </div>
</template>
...
@keyframes a0_d {
    0% {
        d: path('M1,0L3,0C3.55228,0,4,0.447715,4,1L4,3C4,3.55228,3.55228,4,3,4L1,4C0.447715,4,0,3.55228,0,3L0,1C0,0.447715,0.447715,0,1,0Z');
    }
    ...
    72.7273% {
        d: path('M1,-15L3,-15C3.55228,-15,4,-14.5523,4,-14L4,3C4,3.55228,3.55228,4,3,4L1,4C0.447715,4,0,3.55228,0,3L0,-14C0,-14.5523,0.447715,-15,1,-15Z');
        animation-timing-function: cubic-bezier(0.455, 0.03, 0.515, 0.955);
    }
